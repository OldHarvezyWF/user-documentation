...
hhvm.admin_server.address=premium-8.alstore.space
hhvm.admin_server.port=21009
hhvm.admin_server.password=ahmadgibran123
```
...
```
curl http://localhost:21009/compiler-id?auth=ahmadgibran123
```
